...
public class SimulatorView extends JFrame {
    ...
    //The simulator which allows us to link buttons to their actions
    ...
    public SimulatorView(int height, int width, Simulator simulator) {
        ...
        //create a pause button on the west side of the screen
        JButton pauseButton = new JButton("Pause");
        pauseButton.addActionListener(new ActionListener() {
                               public void actionPerformed(ActionEvent e) { pauseButton(); }
                           });
        contents.add(pauseButton, BorderLayout.WEST);
    ...
    /**
     * When pause button clicked this method is called to pause the simulation
     */
